...
exports.event_add = (req,res) =>{
    console.log(req.body);

    const { eventname, eventplace, eventdate, eventmonth, eventfee, eventdescription} = req.body ;
    
        db.query('INSERT INTO event SET ?', {eventname:eventname, eventplace:eventplace, eventdate:eventdate, eventmonth:eventmonth, eventfee:eventfee, eventdescription:eventdescription }, (error,result) => {
            if(error){
                console.log(error)
            }else{
                return res.render('event_add.hbs',{
